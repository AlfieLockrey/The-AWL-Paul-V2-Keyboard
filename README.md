...
This GitHub repo will hopefully contain all the current and past STLs to print he case, plate and wrist rest as well as some DXFs that may be used to cut foam for between the plate and PCB if wanted.
